<nav x-data="{ open: false }" class="bg-black border-b border-white-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link class="text-white" :href="route('residents')" :active="request()->routeIs('residents')">
                        {{ __('Residents') }}
                    </x-nav-link>
                     ...
                     <x-nav-link class="text-white" :href="route('discover')" :active="request()->routeIs('discover')">
                        {{ __('Discover Loog') }}
                    </x-nav-link>
